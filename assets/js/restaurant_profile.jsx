...
var ReviewBox = React.createClass({
  ...
  render: function() {
    return (
      <div className="ReviewBox text-align-center'">
        <h1>Reviews</h1>
...
var ReviewList = React.createClass({
  render: function() {
    var reviewNodes = this.props.data.map(function(review) {
      return (
        <Review subject={review.subject} key={review.id} url={review.url} score={review.score}>
          {review.comment}
        </Review>
      );
    }, this);
    ...
    return (
      <div>
        ...
        <Row className='text-align-center'>
              <Col xs={8} md={6} xsOffset={2} mdOffset={3}>
                <span>
                    Average Score: {this.state.average_score}
                </span>
                <br/>
                <span>
        ...
        <Row className='text-align-center'>
            <ReviewBox restaurantPk={this.state.url_param}/>
        </Row>
    </div>
